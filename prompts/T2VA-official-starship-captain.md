...
MiniMax 官方仓库的可复现 T2VA 案例：星舰舰桥上，女舰长背对镜头凝望观察窗外的深空，镜头缓慢推进。这是官方提供的完整 H3-Context-IR 结构化提示词，配合官方请求脚本可 1:1 复现视频结果。
...
- **类型:** T2VA
- **时长:** ~5 秒 / 24fps
- **来源:** [官方可复现脚本](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/scripts/readme/reproducible-768p-t2va-request.sh) · [视频](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/assets/t2va.mp4)
- **核心技巧:** 完整时间线分镜 + 镜头运动 + 台词 + 三段式声景
- **描述:** 科幻、太空歌剧、电影感、官方验证
