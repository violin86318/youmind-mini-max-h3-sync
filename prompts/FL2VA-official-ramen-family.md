### FL2VA: 官方可复现案例 · 拉面家庭聚会

> ✅ 官方验证案例 — 此提示词与视频为官方仓库提供的可复现配对（768p）

#### 📖 描述

MiniMax 官方仓库的可复现 FL2VA 案例：日式餐厅里热气腾腾的拉面碗前，一家人围桌聚餐。镜头全程静止，浅景深。展示首帧图生视频模式下如何写"保持构图 + 前景焦点"类提示词。
...
- **类型:** FL2VA
- **时长:** 8 秒 / 静止镜头
- **来源:** [官方可复现脚本](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/scripts/readme/reproducible-768p-fl2va-request.sh) · [视频](https://huggingface.co/MiniMaxAI/MiniMax-H3/blob/main/assets/fl2va.mp4)
- **核心技巧:** 首帧全引用指令 + 静态镜头保持 + 浅景深前景聚焦
- **描述:** 美食、家庭、生活流、官方验证
