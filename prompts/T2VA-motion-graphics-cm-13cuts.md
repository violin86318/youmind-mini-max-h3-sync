### T2VA: 动态图形广告「烈 RETSU」（13 个切点）

> 🔥 X 社区精选 — 588♥ 成片案例，提示词与视频均来自[原推](https://x.com/tanabe_fragm/status/2090306302966919515)

#### 📖 描述

由 Claude Code 代写的 15 秒动态图形商业广告：85% 动态平面设计 + 15% 角色动作，严格四色荧光橙/深黑/米白/银灰，13 个精确切点的完整分镜。每个切点标注时间戳与运镜，剪辑节奏全部压在鼓点上，是纯文字生视频复杂分镜的天花板级示范。
...
- **描述:** 由 Claude Code 代写的 15 秒动态图形商业广告：85% 动态平面设计 + 15% 角色动作，严格四色荧光橙…
- **类型:** T2VA
- **来源:** [X @tanabe_fragm](https://x.com/tanabe_fragm/status/2090306302966919515)
- **核心技巧:** 精确切点数声明（Exactly 13 cuts）+ 四色硬约束 + 剪辑节奏锁节拍 + 排他性负向清单
- **标签:** 动态图形, 商业广告, 分镜, 二维动画, Claude Code
